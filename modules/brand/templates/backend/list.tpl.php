...
<div id="page-wrapper">
  <div class="row">
    <div class="col-lg-12">
      <h1 class="page-header"><?php i18n_echo(array('en' => 'Brand', 'zh' => '品牌')); ?></h1>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="panel panel-default">
        <div class="panel-heading"><?php i18n_echo(array('en' => 'Brand list', 'zh' => '品牌列表')) ?></div>
...
<table class="table table-striped table-bordered table-hover dataTable no-footer">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <a href="<?php print_uri('admin/brand/edit/' . $cat->getId()); ?>"><?php i18n_echo(array('en' => 'Edit', 'zh' => '编辑')) ?></a>
      </td>
    </tr>
    <?php endforeach; ?>
  </tbody>
